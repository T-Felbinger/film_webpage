...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<meta charset="utf-8">
	    <title>Allec Site Builder Installation</title>
	...
	<div class="container">
        ...
        <h2 class="logo-text">Allec Site Builder</h2>
				...
				<div class="alert alert-success">
					<button type="button" class="close fui-cross" data-dismiss="alert"></button>
				  	<h4>All done, yeah!</h4>
				  	<p>
				  		You're all set! Allec Site Builder has successfully been installed. You can now continue to login and start building awesome websites!
				  	</p>
				  	<p>
				  		Notice! Install folder will be deleted automatically.
 				  	</p>
				  	<a href="../index.php/login" class="btn btn-primary btn-wide btn-embossed"><span class="fui-lock"></span>&nbsp;&nbsp;Log into SITEBUILDER</a>
				</div>
